 ...
 * 2. `[writable]` treasure: {@link TreasureMetadata} 
...
export const mint = (args: MintArgs): TransactionInstruction => {
    ...
    const [treasurePubkey] = pda.deriveTreasureMetadataPDA({
        mint: args.mint,
    }, _programId);
    ...
    return new TransactionInstruction({
        ...
        keys: [
            ...
            {pubkey: treasurePubkey, isSigner: false, isWritable: true},
...
export const getTreasureMetadata = async (
    publicKey: PublicKey,
    commitmentOrConfig: Commitment | GetAccountInfoConfig | undefined = "processed"
): Promise<T.TreasureMetadata | undefined> => {
    ...
    return T.decodeTreasureMetadata(deserialize(T.TreasureMetadataSchema, buffer.data) as Record<string, unknown>);
}
