...
async function main(feePayer: Keypair) {
     ...
     */
    const [treasurePub] = deriveTreasureMetadataPDA(
        {
            mint: mint.publicKey,
        },
        progId,
    );
    console.info("+==== Treasure Metadata Address ====+");
    console.info(treasurePub.toBase58());
    ...
    await mintSendAndConfirm({
        ...
        value: "emerald",
        frequency: "high",
        shortDescription: "possible to collect from easy levels",
        signers: {
            feePayer: feePayer,
            funding: feePayer,
            mint: mint,
     ...
     */
    let treasure = await getTreasureMetadata(treasurePub);
    console.info("+==== Treasure Metadata ====+");
    console.info(treasure);
    console.assert(treasure!.assocAccount!.toBase58(), johnDoeATA.toBase58());
     ...
     * Get the Gem Metadata
     */
    treasure = await getTreasureMetadata(treasurePub);
    console.info("+==== Treasure Metadata ====+");
    console.info(treasure);
    console.assert(treasure!.assocAccount!.toBase58(), janeDoeATA.toBase58());
    ...
    console.info(treasure);
    console.assert(typeof treasure!.assocAccount, "undefined");
}
