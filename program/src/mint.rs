...
pub fn mint(
	...
	treasure: &mut AccountPDA<TreasureMetadata>,
	funding: &AccountInfo,
    ...
    treasure.data.value = value;
    treasure.data.frequency = frequency;
    treasure.data.short_description = short_description;
    treasure.data.mint = *mint.info.key;
    treasure.data.assoc_account = Some(*assoc_token_account.key);
